...
#define CUSTOM_MACHINE_NAME "Drucker Brudi"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT { 66.67, 66.67, 2403, 1408.74 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9600, 9600, 200, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 20.35, -1 }
 ...
 */
// Must be 0 0 or probing fails during ABL
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT Y_MAX_POS - 30  // Y point for Z homing
#endif
